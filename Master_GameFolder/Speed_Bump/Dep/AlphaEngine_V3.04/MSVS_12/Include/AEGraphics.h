...
/******************************************************************************/
/*!
\fn		   void AEGfxCone (f32 x0, f32 y0, f32 z0, 
...
\brief      Draw a 3D cone on screen. 

\details    The base of the cone is centered around the point 
            (x0, y0, z0) with size radius. The tip of the cone is 
            at point(x1, y1, z1). c0 and c1 are the sphere color. 
            Default colors are white and grey. Division is the 
            resolution of the cone, or how many parts the cone 
            consists of. Default value is 8.
...
\param      [in] x0
            X coordinate of the center of the base of cone

\param      [in] y0
            Y coordinate of the center of the base of cone

\param      [in] z0
            Z coordinate of the tip of cone

\param      [in] x1
            X coordinate of the tip of cone

\param      [in] y1
            Y coordinate of the tip of cone
...
\param      [in] c0
            First color of the cone.

\param      [in] c1
            Second color of the cone.

\param      [in] division
            Number of parts to divide the cone by. 

\retval     void
            No return.
*/
/******************************************************************************/
AE_API void			    AEGfxCone		(f32 x0, f32 y0, f32 z0, 
                                         f32 x1, f32 y1, f32 z1, 
                                         f32 radius, u32 c0, u32 c1, u32 division);
...
AE_API u32  AEGfxCreateFont(const char * fontName, int sizeF, bool bold, bool italic);
AE_API void AEGfxPrint(u32 fontId, s8* pStr, s32 positionx, s32 positiony, f32 red, f32 green, f32 blue);
AE_API void AEGfxDestroyFont(u32 fontId);
